 ...
 */
@WebServlet(name = "ListeCommandeClientServlet", urlPatterns = {"/ListeCommandeClientServlet"})
public class ListeCommandeClientServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            resultat.put("records", daoC.getCommande());
